...
def get_bams_per_sample(wildcards):
    bam_path = "output/hg38_no_alts/minimap2_hg38_no_alts/{setting}/{specimen}/{lane}/{smrtcell}.filt.sorted.bam"
...
rule minimap2_standard: 
    ...
    output: temp("output/hg38_no_alts/minimap2_hg38_no_alts/standard/{specimen}/{lane}/{smrtcell}.filt.bam")
    params:
        refgenome = "/global/scratch/users/stacy-l/references/hg38_HGSVC/hg38.no_alt.fa.gz",
...
rule minimap2_softclip:
    ...
    input:
        hifi = "output/HiFiAdapterFilt/{specimen}/{lane}/{smrtcell}.ccs.filt.fastq.gz"
    output: temp("output/hg38_no_alts/minimap2_hg38_no_alts/softclip/{specimen}/{lane}/{smrtcell}.filt.bam")
    params:
        refgenome = "/global/scratch/users/stacy-l/references/hg38_HGSVC/hg38.no_alt.fa.gz",
        readgroup = '@RG\\tID:{lane}\\tSM:{specimen}\\tPU:{smrtcell}\\tPL:PACBIO',
        minQ = 10
...
rule samtools_sort:
    ...
    input: "output/hg38_no_alts/minimap2_hg38_no_alts/{setting}/{specimen}/{lane}/{smrtcell}.filt.bam"
    output: temp("output/hg38_no_alts/minimap2_hg38_no_alts/{setting}/{specimen}/{lane}/{smrtcell}.filt.sorted.bam")
    threads: 32
    conda: "../envs/minimap2.yml"
...
rule collate_bams:
    ...
    output: "output/hg38_no_alts/minimap2_hg38_no_alts/{setting}/{specimen}/{specimen}.sorted.merged.bam"
    threads: 32
    conda: "../envs/minimap2.yml"
...
rule index_bam:
    version: subprocess.run(["samtools --version"], stdout=subprocess.PIPE, shell=True).stdout.decode('utf-8').strip('\n')
    input: "output/hg38_no_alts/minimap2_hg38_no_alts/{setting}/{specimen}/{specimen}.sorted.merged.bam"
    output: "output/hg38_no_alts/minimap2_hg38_no_alts/{setting}/{specimen}/{specimen}.sorted.merged.bam.bai"
    threads: 32
    conda: "../envs/minimap2.yml"
    shell: """
