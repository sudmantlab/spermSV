rule minimap2:
    ...
    threads: 40
    shell: "minimap2 --version && minimap2 -Y -y -L --eqx --cs --MD '{params.readgroup}' -t {threads} -ax map-hifi {params.refgenome} {input.hifi} | samtools view -q {params.minQ} -bT {params.refgenome} -o {output}"