rule ref_index:
    input:
        "/global/scratch/users/stacy-l/references/hg38/GCF_000001405.40_GRCh38.p14_genomic.fna"
    output:
        "/global/scratch/users/stacy-l/references/hg38/GCF_000001405.40_GRCh38.p14_genomic.fai"
    threads: 20
...
rule DeepVariant:
    ...
    params:
        ...
        refindex = "/global/scratch/users/stacy-l/references/hg38/GCF_000001405.40_GRCh38.p14_genomic.fai",
        mount_dir = "/global/scratch/users/stacy-l",
        out_dir = "output/DeepVariant",
        int_dir = "output/DeepVariant/{model}/intermediate",
        cache_dir = "/global/scratch/users/stacy-l/software/singularity",
    output:
        vcf="output/DeepVariant/{model}/{specimen}.vcf.gz",
        gvcf="output/DeepVariant/{model}/{specimen}.g.vcf.gz",
        vcf_index="output/DeepVariant/{model}/{specimen}.vcf.gz.tbi",
        gvcf_index="output/DeepVariant/{model}/{specimen}.g.vcf.gz.tbi",
        report="output/DeepVariant/{model}/{specimen}.visual_report.html"
    conda: "../envs/DeepVariant.yml"
